...
//           {streams.map((stream) => (
//             <CardContainer key={stream._id} className="inter-var w-full" containerClassName="w-full">
//               <CardBody className="bg-slate-800 relative group/card hover:shadow-2xl hover:shadow-blue-500/[0.1] border-slate-700 w-full rounded-xl p-4 border">
...
//               <CardItem
//                 translateZ="30"
//                 className="flex items-center space-x-4 text-xs text-slate-400 mb-3"
//               >
...
//                   <svg className="w-10 h-10 mx-auto mb-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
//                   </svg>
